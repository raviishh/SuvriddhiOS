...
export default function Learn() {
    const { setLastActivity, markItemCompleted, isItemCompleted, subject } =
        useStore();
    ...
    function onMarkComplete() {
        ...
        function onMarkComplete() {
            ...
            if (
                !completedItems.find(
                    (i: any) =>
                        i.itemId === active.itemId &&
                        i.topicId === active.topicId,
                )
            ) {
                completedItems.push({
    ...
    return (
        <div
            className={`min-h-screen flex overflow-hidden h-screen font-display theme-${subject}`}
        >
            <Sidebar
                topics={topics}
