...
export default function DebugCodeView({ drill, onMarkComplete }) {
    ...
    const [code, setCode] = useState(drill.buggyCode);
    ...
    return (_jsxs("div", { className: "grow p-6 flex flex-col", children: [_jsxs("div", { className: "mb-6", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h2", { className: "text-2xl font-bold", children: drill.title }), _jsx("span", { className: `px-3 py-1 rounded-full text-xs font-medium ${drill.difficulty === "easy" ? "bg-green-500/20 text-green-500" :
                                    drill.difficulty === "medium" ? "bg-yellow-500/20 text-yellow-500" :
                                        "bg-red-500/20 text-red-500"}`, children: drill.difficulty })] }), _jsx("p", { className: "text-muted-foreground mb-4", children: drill.description }), _jsxs("p", { className: "text-sm text-muted-foreground", children: ["Expected Output: ", _jsx("code", { className: "bg-card px-2 py-1 rounded", children: drill.expectedOutput })] }), drill.hint && (_jsxs("div", { className: "mt-4", children: [_jsxs("button", { onClick: () => setShowHint(!showHint), className: "flex items-center gap-2 text-sm text-primary hover:underline", children: [_jsx(Lightbulb, { size: 16 }), showHint ? "Hide Hint" : "Show Hint"] }), showHint && (_jsxs("div", { className: "mt-2 p-3 bg-primary/10 border border-primary/20 rounded-md text-sm", children: ["\uD83D\uDCA1 ", drill.hint] }))] }))] }), _jsxs("div", { className: "flex-1 flex flex-col", children: [_jsx("div", { className: "border border-border rounded-lg overflow-hidden shadow-sm bg-card", children: _jsx(AceEditor, { mode: "c_cpp", theme: "tomorrow_night_eighties", name: "editor", value: code, onChange: (val) => setCode(val), fontSize: 14, width: "100%", height: "400px", showPrintMargin: false, showGutter: true, highlightActiveLine: true, setOptions: {
                                enableBasicAutocompletion: false,
                                enableLiveAutocompletion: false,
                                enableSnippets: false,
                                useWorker: false,
                                tabSize: 2,
                            } }) }), _jsxs("div", { className: "mt-4 flex items-center gap-3", children: [_jsx("button", { onClick: handleSubmit, disabled: running, className: "px-4 py-2 rounded-md bg-primary-muted text-primary-foreground disabled:opacity-50", children: running ? "Running..." : "Test Fix" }), _jsx("button", { onClick: () => { setCode(drill.buggyCode); }, className: "px-3 py-2 rounded-md border border-border", children: "Reset" })] }), _jsx(OutputFeedback, { output: output, isSuccess: isSuccess, successMessage: "Bug fixed!", emptyMessage: "No output yet. Test your fix to see results." })] })] }));
}
